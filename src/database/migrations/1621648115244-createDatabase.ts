...
export class createDatabase1621648115244 implements MigrationInterface {
    name = 'createDatabase1621648115244'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "usuario" ("usuario_id" uuid NOT NULL DEFAULT gen_random_uuid(), "email" character varying(100) NOT NULL, "password" character varying(72) NOT NULL, "habilitado" boolean NOT NULL DEFAULT true, "sospechoso" boolean NOT NULL DEFAULT false, "require_survey" boolean NOT NULL, CONSTRAINT "UQ_2863682842e688ca198eb25c124" UNIQUE ("email"), CONSTRAINT "PK_877d906b2b8b32d99cf7164ec19" PRIMARY KEY ("usuario_id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "respuesta_respuesta_enum" AS ENUM('si', 'no')`);
        await queryRunner.query(`CREATE TABLE "respuesta" ("detalle_id" SERIAL NOT NULL, "respuesta" "respuesta_respuesta_enum" NOT NULL, "encuesta_id" integer, "pregunta_id" integer, CONSTRAINT "PK_d2276fc761f3baf318a2881556e" PRIMARY KEY ("detalle_id"))`);
        await queryRunner.query(`CREATE TABLE "encuesta" ("encuesta_id" SERIAL NOT NULL, "otros_sintomas" text, "fecha_aplicacion" TIMESTAMP NOT NULL DEFAULT now(), "usuario_id" uuid, CONSTRAINT "PK_598e1bbe349b40ff0b465914804" PRIMARY KEY ("encuesta_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "respuesta" ADD CONSTRAINT "FK_f5619719860d6957dbc0f841dab" FOREIGN KEY ("encuesta_id") REFERENCES "encuesta"("encuesta_id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "respuesta" ADD CONSTRAINT "FK_8bf15f198bc42bc6214e6564732" FOREIGN KEY ("pregunta_id") REFERENCES "pregunta"("pregunta_id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "respuesta" DROP CONSTRAINT "FK_8bf15f198bc42bc6214e6564732"`);
        await queryRunner.query(`ALTER TABLE "respuesta" DROP CONSTRAINT "FK_f5619719860d6957dbc0f841dab"`);
        ...
        await queryRunner.query(`DROP TYPE "respuesta_respuesta_enum"`);
